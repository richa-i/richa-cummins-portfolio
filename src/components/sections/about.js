    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! I'm Richa Singh, a final year student with keen interest in Data Structures and
              Algorithms.
            </p>

            <p>
              I am pursuing my Bachelors from{' '}
              <a href="https://cumminscollege.edu.in/">CCOEW, Nagpur</a> in Computer Science
              (2020-2024) with Cumulative GPA of 9.01/10.
            </p>
